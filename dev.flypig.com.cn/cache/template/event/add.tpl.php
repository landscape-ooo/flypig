...
<script type="text/javascript" src="<?php echo SITE_URL;?>public/js/date/WdatePicker.js?4.72"></script>
<script type="text/javascript">
$(function(){
	$("#sel_province").change(function(){
		var provinceId = $(this).val();
		var provinceUrl = "<?php echo SITE_URL;?>index.php?app=user&ac=city&provinceid=" + provinceId;
		$("#citySpan").load(provinceUrl, function(){
			...
			if($("#sel_city").length > 0){
				$("#sel_city").change(function(){
					var cityId = $(this).val();
					var cityUrl = "<?php echo SITE_URL;?>index.php?app=user&ac=area&cityid=" + cityId;
...
<div id="path">
	...
	<a href="<?php echo SITE_URL;?>" title="<?php echo $TS_SITE['base'][site_title];?>首页">首页</a>  &gt;  <a href="<?php echo tsurl('event')?>" title="<?php echo $TS_APP['options'][appname];?>"><?php echo $TS_APP['options'][appname];?></a>  &gt;  发起新活动
</div>
	...
	<div class="bd-left">
		...
		<div id="event-edit" class="com-box">
			<div class="editor">
				...
				<form method="POST" action="<?php echo SITE_URL;?>index.php?app=event&ac=add&ts=do" enctype="multipart/form-data" onsubmit="return addFormCheck()">
