	...
	var methods = {
			...
			return this.each(function () {
				...
				var divUpDown =
					"<div class='ms2side__updown'>" +
						(o.labelSort ? "<p class='SelSort' title='Sort'>" + o.labelSort + "</p>" : "") +
						(o.labelTop ? "<p class='MoveTop' title='Move on top selected option'>" + o.labelTop + "</p>" : "") +
						(o.labelUp ? "<p class='MoveUp' title='Move up selected option'>" + o.labelUp + "</p>" : "") +
						(o.labelDown ? "<p class='MoveDown' title='Move down selected option'>" + o.labelDown + "</p>" : "") +
						(o.labelBottom ? "<p class='MoveBottom' title='Move on bottom selected option'>" + o.labelBottom + "</p>" : "") +
					"</div>";
				...
				if (o.search != false && o.optGroupSearch != false) {
					var ss = 
						o.optGroupSearch + "<select class='small' ><option value=__null__>" + o.optGroupDefault + "</option></select> " +
					...
					var ss = o.optGroupSearch + "<select><option value=__null__>" + o.optGroupDefault + "</option></select>";
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__select'>" +
							...
							"<select name='" + nameDx + "' id='" + nameDx + "' size='" + o.minSize + "' multiple='multiple' ></select>" +
						"</div>" +
						((o.selectedPosition == 'right' && o.moveOptions) ? divUpDown : "") +
					"</div>";
				...
				if (o.optGroupSearch != false) {
					...
					//adan FIX optGroupSearch Bug
					//searchSelect = $(this).next().find("select").eq(0);
					searchSelect = $(this).next().find("select").eq(o.selectedPosition == 'right' ? 0 : 1);
					///
		...
		addOption : function(options) {
			...
			return this.each(function () {
				...
				if(oAddOption.group)
					el.find("optgroup[label=" + oAddOption.group + "]").append(strEl);
				else
					el.append(strEl);
