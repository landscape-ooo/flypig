...
//载入htmlpurifier库
include THINKROOT.'/thinksaas/htmlpurifier/library/HTMLPurifier.includes.php';
include THINKROOT.'/thinksaas/htmlpurifier/library/HTMLPurifier.auto.php';

//加载基础函数
include 'tsFunction.php';

//adan加载扩展函数
include 'extendFunction.php';
///
...
//APP专用
//adan修改
$app = isset($_GET['app']) ? tsUrlCheck($_GET['app']) : 'index';
///
...
//adan
//BackUrl专用
$bu = isset($_GET['bu']) ? tsUrlCheck($_GET['bu']) : false;
///
